<x-app-layout>
    ...
    <div class="py-6 max-w-7xl mx-auto">
        <form id="formEditSiswa">
            ...
            <input type="text" name="nama" id="nama" value="{{ $siswa->nama }}" class="w-full border p-2 rounded">
        ...
        <div id="successMessage" class="text-green-500 mt-2 hidden">Siswa berhasil diperbarui!</div>
